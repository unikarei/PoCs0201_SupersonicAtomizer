...
from supersonic_atomizer.io import build_output_metadata, simulation_result_to_dict, write_simulation_result_json
...
class TestRuntimeJsonWriter(unittest.TestCase):
    def test_converts_to_documented_json_shape(self) -> None:
        simulation_result = _make_result()
        payload = simulation_result_to_dict(simulation_result)
    ...
    def test_writes_expected_json_content(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            json_path = write_simulation_result_json(simulation_result)
    ...
    def test_requires_destination_when_output_metadata_is_absent(self) -> None:
        ...
        with self.assertRaises(OutputError):
            write_simulation_result_json(simulation_result)
